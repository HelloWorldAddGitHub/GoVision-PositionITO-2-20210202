...
namespace GoCommon
{
    public class IniTool
    {
        ...
        public static bool Set(string iniFile, string section, string key, string value)
        {
            return WriteValue(iniFile, section, key, value);
        }

        public static bool Set(string iniFile, string section, string key, int value)
        {
            return WriteValue(iniFile, section, key, value.ToString());
        }

        public static bool Set(string iniFile, string section, string key, long value)
        {
            return WriteValue(iniFile, section, key, value.ToString());
        }

        public static bool Set(string iniFile, string section, string key, bool value)
        {
        ...
        public static double GetDouble(string iniFile, string section, string key, double defaultValue)
        {
            double result;
            string value = GetString(iniFile, section, key, defaultValue.ToString());
